    ...
    <div class="card" style="width: 100%; max-width: 450px; background: var(--color-bg); box-shadow: 0 20px 25px rgba(0,0,0,0.3); position: relative; z-index: 10;">
        ...
        <form method="POST" action="{{ route('password.email') }}" id="resetForm">
            ...
            <div style="text-align: center; margin-bottom: 1.5rem;">
                <h2 style="font-size: 1.5rem; font-weight: bold; margin: 0;">Reset Password</h2>
            </div>

            <div class="alert alert-info mb-4">
                <p class="text-sm">
                    Masukkan email dan password baru Anda untuk mereset akun secara langsung.
                </p>
            </div>
            ...
            <div class="form-group">
                ...
                @error('password')
                    <span class="text-danger text-sm">{{ $message }}</span>
                @enderror
                <small style="color: var(--color-text-light);">Minimal 8 karakter</small>
            </div>
