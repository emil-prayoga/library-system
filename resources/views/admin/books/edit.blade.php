...
<div style="width:100%; margin: 0 auto;">
    <div class="admin-header">
        <h1 style="margin-top: 0; color: #1f2937; margin-bottom: 0.5rem;">Edit Buku</h1>
        <p style="color: #6b7280; ">Perbarui informasi buku</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.books.update', $book) }}" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    ...
                    <input type="text" name="author"
                           value="{{ old('author', $book->author) }}" required placeholder="Masukkan nama pengarang"
                           style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; font-size: 1rem; transition: border-color 0.2s ease;"
                           onfocus="this.style.borderColor='#667eea'" 
                           onblur="this.style.borderColor='#e5e7eb'">
                    @error('author')
                ...
                <div>
                    ...
                    <input type="text" name="isbn"
                           value="{{ old('isbn', $book->isbn) }}" required placeholder="Masukkan nomor ISBN"
                           style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; font-size: 1rem; transition: border-color 0.2s ease;"
                           onfocus="this.style.borderColor='#667eea'" 
                           onblur="this.style.borderColor='#e5e7eb'">
                    @error('isbn')
                ...
                <div>
                    ...
                    <input type="text" name="publisher"
                           value="{{ old('publisher', $book->publisher) }}" required placeholder="Masukkan nama penerbit"
                           style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; font-size: 1rem; transition: border-color 0.2s ease;"
                           onfocus="this.style.borderColor='#667eea'" 
                           onblur="this.style.borderColor='#e5e7eb'">
                    @error('publisher')
                ...
                <div>
                    ...
                    <input type="date" name="published_date"
                           value="{{ old('published_date', optional($book->published_date)->format('Y-m-d')) }}"
                           style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; font-size: 1rem; transition: border-color 0.2s ease;"
                           onfocus="this.style.borderColor='#667eea'" 
                           onblur="this.style.borderColor='#e5e7eb'">
                ...
                <div>
                    ...
                    <input type="number" name="stock"
                           value="{{ old('stock', $book->stock) }}" required min="0" placeholder="Masukkan jumlah stok"
                           style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; font-size: 1rem; transition: border-color 0.2s ease;"
                           onfocus="this.style.borderColor='#667eea'" 
                           onblur="this.style.borderColor='#e5e7eb'">
                    @error('stock')
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="description" rows="4" placeholder="Masukkan deskripsi singkat tentang buku"
                          ...
                          onfocus="this.style.borderColor='#667eea'" 
                          onblur="this.style.borderColor='#e5e7eb'">{{ old('description', $book->description) }}</textarea>
                @error('description')
                    <p style="color: #dc2626; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <p style="color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem;">Format: JPG, PNG, GIF. Ukuran maksimal: 5MB. Kosongkan jika tidak ingin mengubah.</p>
                @error('cover')
                    <p style="color: #dc2626; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
                @enderror
                ...
                @if($book->cover)
                    <div style="margin-top: 1.5rem; padding: 1rem; background: #f9fafb; border-radius: 0.375rem;">
                        <p style="color: #6b7280; font-size: 0.875rem; margin-bottom: 0.75rem; margin-top: 0;">📷 Sampul Saat Ini:</p>
                        <div style="max-width: 200px;">
                            <img src="{{ Storage::url($book->cover) }}" style="width: 100%; border-radius: 0.375rem; border: 1px solid #e5e7eb;">
                        </div>
                    </div>
                @endif
            ...
            reader.onload = function(e) {
                preview.innerHTML = `
                    <div style="margin-top: 1rem; padding: 1rem; background: #f9fafb; border-radius: 0.375rem;">
                        <p style="color: #6b7280; font-size: 0.875rem; margin-bottom: 0.75rem; margin-top: 0;">📷 Gambar Baru:</p>
                        <div style="max-width: 200px;">
